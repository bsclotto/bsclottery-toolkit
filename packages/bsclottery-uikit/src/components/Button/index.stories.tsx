...
export const Anchors: React.FC = () => {
  return (
    <>
      ...
      <Box>
        <Button as="a" href="https://bsclotteryswap.finance" mr="8px" external disabled>
          Disabled
        </Button>
        <Button as="a" href="https://bsclotteryswap.finance" variant="secondary" external disabled>
          Disabled
        </Button>
      </Box>
    </>

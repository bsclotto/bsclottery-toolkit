...
it("renders correctly", () => {
  ...
  expect(asFragment()).toMatchInlineSnapshot(`
    ...
    .c3:hover:not(:disabled):not(.bsclottery-button--disabled):not(.bsclottery-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c3:active:not(:disabled):not(.bsclottery-button--disabled):not(.bsclottery-button--disabled) {
      opacity: 0.85;
    }

    .c3:disabled,
    .c3.bsclottery-button--disabled {
    ...
    .c8:hover:not(:disabled):not(.bsclottery-button--disabled):not(.bsclottery-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c8:active:not(:disabled):not(.bsclottery-button--disabled):not(.bsclottery-button--disabled) {
      opacity: 0.85;
    }

    .c8:disabled,
    .c8.bsclottery-button--disabled {
      background-color: #E9EAEB;
      border-color: #E9EAEB;
      box-shadow: none;
      color: #BDC2C4;
    ...
    .c24:hover:not(:disabled):not(.bsclottery-button--disabled):not(.bsclottery-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c24:active:not(:disabled):not(.bsclottery-button--disabled):not(.bsclottery-button--disabled) {
      opacity: 0.85;
    }

    .c24:disabled,
    .c24.bsclottery-button--disabled {
      background-color: #E9EAEB;
      border-color: #E9EAEB;
      box-shadow: none;
      color: #BDC2C4;
      ...
      >
        ...
        >
          ...
          >
            ...
            <a
              aria-label="Bsclottery home page"
              class="c6"
              href="/"
            >
              <svg

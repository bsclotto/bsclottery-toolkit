...
it("renders ConnectModal correctly", () => {
  ...
  expect(asFragment()).toMatchInlineSnapshot(`
    ...
    .c7:hover:not(:disabled):not(.bsclottery-button--disabled):not(.bsclottery-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c7:active:not(:disabled):not(.bsclottery-button--disabled):not(.bsclottery-button--disabled) {
      opacity: 0.85;
    }

    .c7:disabled,
    .c7.bsclottery-button--disabled {
    ...
    .c12:hover:not(:disabled):not(.bsclottery-button--disabled):not(.bsclottery-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c12:active:not(:disabled):not(.bsclottery-button--disabled):not(.bsclottery-button--disabled) {
      opacity: 0.85;
    }

    .c12:disabled,
    .c12.bsclottery-button--disabled {
      background-color: #E9EAEB;
      border-color: #E9EAEB;
      box-shadow: none;
      color: #BDC2C4;
    ...
    .c15:hover:not(:disabled):not(.bsclottery-button--disabled):not(.bsclottery-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c15:active:not(:disabled):not(.bsclottery-button--disabled):not(.bsclottery-button--disabled) {
      opacity: 0.85;
    }

    .c15:disabled,
    .c15.bsclottery-button--disabled {
      background-color: #E9EAEB;
      border-color: #E9EAEB;
      box-shadow: none;
      color: #BDC2C4;
      ...
      >
        ...
        >
          ...
          <a
            class="c16 c17 c18"
            color="primary"
            href="https://docs.bsclotteryswap.finance/guides/faq#how-do-i-set-up-my-wallet-on-binance-smart-chain"
